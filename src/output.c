...
int  savehyd(EN_Project *m, long *htime)
/*
**--------------------------------------------------------------
...
int  savehydstep(EN_Project *m, long *hydstep)
/*
**--------------------------------------------------------------
...
int  readhyd(EN_Project *m, long *hydtime)
/*
**--------------------------------------------------------------
**   Input:   none                                                
...
int  readhydstep(EN_Project *m, long *hydstep)
/*
**--------------------------------------------------------------
**   Input:   none                                                
...
int  nodeoutput(EN_Project *m, int j, REAL4 *x, double ucf)
/*
**--------------------------------------------------------------
...
int  linkoutput(EN_Project *m, int j, REAL4 *x, double ucf)
/*
**----------------------------------------------------------------
...
int  savefinaloutput(EN_Project *m)
/*
**--------------------------------------------------------------
**  Input:   none                                          
**  Output:  returns error code                                  
...
int  savetimestat(EN_Project *m, REAL4 *x, char objtype)
/*
**--------------------------------------------------------------
...
int  savenetreacts(EN_Project *m, double wbulk, double wwall, double wtank, double wsource)
/*
**-----------------------------------------------------
